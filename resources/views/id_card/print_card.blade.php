...
<body style="font-family: 'CenturyGothic', sans-serif; font-weight: 400; font-size: 16px; line-height: 20px;">
	...
	<img src="{{ asset('uploads/idcard_photo/'.$data->display_photo) }}" style="height: 245px; position: absolute; left: 45px; top:105px; width: 220px !important;">

	<p style="position: absolute; left: 289px; top:155px; font-weight: 700; font-size: 20px;">@if ($data->card_type == 1) {{ $data->student_name }} @else {{ $data->teacher_name }} @endif</p>

	<p style="position: absolute; left: 289px; top:231px; font-weight: 700; font-size: 20px; width: 410px;">@if ($data->card_type == 1) {{ $data->dob }} @else {{ $data->address1 }} {{ $data->address2 }}, {{ $data->city }} @endif</p>

	<p style="position: absolute; left: 289px; top:307px; font-weight: 700; font-size: 20px;">@if ($data->card_type == 1) {{ $data->teacher_name }} @else {{ $data->phone_number }} @endif</p>

	<p style="position: absolute; left: 525px; top:154px; font-weight: 700; font-size: 20px;">{{ $data->id_number }}</p>
